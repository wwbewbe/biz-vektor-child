...
<div id="post-<?php the_ID(); ?>" class="infoListBox ttBox">
	...
	<a href="<?php the_permalink(); ?>"><img src="<?php echo (get_thumb('full')); ?>" alt=""></a>
	</div>
	</div><!-- Customize to algin left with image [ /.thumbImage ] -->

	<p class="entryMeta">
	<span class="infoDate"><?php echo esc_html( get_the_date() ); ?></span><span class="infoCate"><?php echo $taxo_catelist; ?></span>
	</p>
	<p><?php the_excerpt(); ?></p>
	<div class="moreLink"><a href="<?php the_permalink(); ?>"><?php echo esc_html( apply_filters( 'read_more_txt', _x( 'Read more','Link to post', 'biz-vektor' ) ) ); ?></a></div>
	</div><!-- [ /.entryTxtBox ] -->
